...
import { ClientResolver } from '@app/shared/_resolvers/firm-portal/client.resolver';
import { CurrentFirmResolver } from '@app/shared/_resolvers/firm-portal/current-firm.resolver';
import { CurrentUserResolver } from '@app/shared/_resolvers/current-user.resolver';
import { DocumentResolver } from '@app/shared/_resolvers/firm-portal/document.resolver';
import { LegalAreaResolver } from '@app/shared/_resolvers/firm-portal/legal-area.resolver';
import { MatterResolver } from '@app/shared/_resolvers/firm-portal/matter.resolver';
import { StaffResolver } from '@app/shared/_resolvers/firm-portal/staff.resolver';
