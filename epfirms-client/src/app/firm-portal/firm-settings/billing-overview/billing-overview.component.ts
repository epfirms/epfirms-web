...
export class BillingOverviewComponent implements OnInit {
  ...
  constructor(private _stripeService: StripeService, private _modalService: EpModalService, private fb: FormBuilder) {}
  ...
  addFundsModal() {
    this._modalService.create({
      epContent: BillingPaymentComponent,
      epComponentParams: {
  ...
  saveAutoRecharge() {
    this._stripeService.updateCustomer(this.customer.id, {metadata: this.autoRechargeMetadata.value}).subscribe();
  }
