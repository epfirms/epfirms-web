...
@Component({
  selector: 'app-community-case-template-details-page',
  templateUrl: './community-case-template-details-page.component.html',
  styleUrls: ['./community-case-template-details-page.component.scss']
})
export class CommunityCaseTemplateDetailsPageComponent implements OnInit {
  public template;
