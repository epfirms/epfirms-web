...
private parseForm() : any {
  let form = {
    ...
    property_1_loan_amount: parseFloat(this.toStringFloat(this.financialSummaryForm.property_1_loan_amount)),
    ...
    property_2_loan_amount: parseFloat(this.toStringFloat(this.financialSummaryForm.property_2_loan_amount)),
    ...
    property_3_loan_amount: parseFloat(this.toStringFloat(this.financialSummaryForm.property_3_loan_amount)),
    ...
    property_4_loan_amount: parseFloat(this.toStringFloat(this.financialSummaryForm.property_4_loan_amount)),
...
submit(): void {
  ...
  this.financialSummaryService.upsert(this.parseForm()).subscribe(
    res => {
      console.log("res", res);
    }
  )
