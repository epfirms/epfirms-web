...
@Component({
  selector: 'app-balance-add-funds',
  templateUrl: './balance-add-funds.component.html',
  styleUrls: ['./balance-add-funds.component.scss']
})
export class BalanceAddFundsComponent implements OnInit {
